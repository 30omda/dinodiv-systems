        ...
        <div className="hidden items-center gap-8 md:flex">
          {navLinks.map((link) => (
            <a
              ...
              className={`rounded-md text-sm font-medium transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${

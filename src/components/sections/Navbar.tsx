  ...
  return (
    ...
    >
      <div className="container flex h-20 items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          {navLinks.map((link) => (
            <a
              ...
              className={`rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
        ...
        {/* Mobile toggle */}
        <button
          className="rounded-md p-1 text-foreground transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary md:hidden"
        ...
        {mobileOpen && (
          ...
          >
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollTo(e, link.href)}
                className={`block rounded-md py-3 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ${
                  activeSection === link.id ? "text-primary" : "text-muted-foreground"
                } hover:text-primary`}
              >
              {link.label}
          ...
          */}
          <a
            href="#contact"
            onClick={(e) => scrollTo(e, "#contact")}
            className="mt-2 block rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-semibold text-primary-foreground transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
          >
            Start Your Project
          </a>
          </motion.div>

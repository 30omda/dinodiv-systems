        ...
        <div className="hidden items-center gap-8 md:flex">
          {navLinks.map((link) => (
            <a
              ...
              className={`px-1 -mx-1 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-sm font-medium transition-all hover:text-primary ${
        ...
        {mobileOpen && (
          ...
          >
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollTo(e, link.href)}
                className={`block py-3 px-1 -mx-1 rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-sm font-medium transition-all hover:text-primary ${
                  activeSection === link.id ? "text-primary" : "text-muted-foreground"
                }`}
              >
                {link.label}
          ...
          */}
            <a
              href="#contact"
              onClick={(e) => scrollTo(e, "#contact")}
              className="mt-2 block rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-semibold text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
              Start Your Project
            </a>
          </motion.div>

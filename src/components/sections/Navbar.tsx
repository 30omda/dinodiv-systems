          ...
          >
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollTo(e, link.href)}
                className={`block py-3 text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md hover:text-primary ${
                  activeSection === link.id ? "text-primary" : "text-muted-foreground"
                }`}
              >
                {link.label}

  ...
  return (
    ...
    >
      <div className="container flex h-20 items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          {navLinks.map((link) => (
            <a
              ...
              className={`rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary hover:text-primary ${
        ...
        {/* Mobile toggle */}
        <button
          className="p-2 text-foreground transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary md:hidden"

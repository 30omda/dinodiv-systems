  ...
  return (
    ...
    >
      <div className="container flex h-20 items-center justify-between px-6">
        ...
        {/* Mobile toggle */}
        <button
          className="p-2 rounded-md text-foreground md:hidden transition-colors hover:bg-accent/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
        ...
        {mobileOpen && (
          ...
          */}
          <a
            href="#contact"
            onClick={(e) => scrollTo(e, "#contact")}
            className="mt-2 block rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90"
          >
            Start Your Project
          </a>
          </motion.div>

...
const Navbar = () => {
  ...
  return (
    <>
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-primary focus:text-primary-foreground focus:rounded-md focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background font-medium text-sm transition-all"
      >
      ...
      <div className="container flex h-20 items-center justify-between px-6">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          */}
          <a
            ...
            className="rounded-lg bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground transition-all hover:bg-primary/90 glow-green focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
          >
            Start Your Project
          </a>
        </div>
        ...
        <button
          type="button"
          className="text-foreground md:hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md p-2 transition-all"
          ...
          >
            {navLinks.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => scrollTo(e, link.href)}
                className={`block py-3 text-sm font-medium transition-all hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md px-1 -ml-1 ${
                  activeSection === link.id ? "text-primary" : "text-muted-foreground"
                }`}
              >
                {link.label}

            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="text-sm text-primary transition-colors hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded px-1 -ml-1"
                >
                  Let's Talk →
                </a>
              </div>

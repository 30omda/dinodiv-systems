            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="px-1 -ml-1 text-sm text-muted-foreground transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary rounded outline-none"
                >
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center text-sm text-muted-foreground">
                  <a
                    ...
                    className="px-1 -ml-1 transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary rounded outline-none"
                  >
                    +201028661605
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-1 transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary rounded outline-none"
                  >
                    +201125011939
                  </a>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-1 -ml-1 text-sm text-primary transition-colors hover:underline focus-visible:ring-1 focus-visible:ring-primary rounded outline-none"
                >
                  Let's Talk →
                </a>
              </div>

            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="px-1 -ml-1 text-sm text-muted-foreground transition-colors hover:text-primary focus-visible:ring-2 focus-visible:ring-primary outline-none rounded-sm"
                >
              ...
              <div>
                ...
                <div className="flex flex-wrap text-sm text-muted-foreground">
                  <a
                    ...
                    className="px-1 -ml-1 transition-colors hover:text-primary focus-visible:ring-2 focus-visible:ring-primary outline-none rounded-sm"
                  >
                    +201028661605
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-1 transition-colors hover:text-primary focus-visible:ring-2 focus-visible:ring-primary outline-none rounded-sm"
                  >
                    +201125011939
                  </a>
                </div>

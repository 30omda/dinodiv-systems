            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="px-1 -ml-1 rounded text-sm text-muted-foreground transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary outline-none"
                >
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center text-sm text-muted-foreground">
                  <a href="https://wa.me/201028661605" target="_blank" rel="noopener noreferrer" className="px-1 -ml-1 rounded transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary outline-none">+201028661605</a>
                  <span className="px-1">/</span>
                  <a href="https://wa.me/201125011939" target="_blank" rel="noopener noreferrer" className="px-1 rounded transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary outline-none">+201125011939</a>
                </div>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="px-1 -ml-1 rounded text-sm text-primary transition-colors hover:underline focus-visible:ring-1 focus-visible:ring-primary outline-none"
                >
                  Let's Talk →
                </a>
              </div>

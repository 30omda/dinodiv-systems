              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
                  <a
                    ...
                    className="px-1 -ml-1 transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md"
                  >
                    +201028661605
                  </a>
                  <span>/</span>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-1 transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md"
                  >
                    +201125011939
                  </a>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-1 -ml-1 text-sm text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md"
                >
                  Let's Talk →
                </a>
              </div>

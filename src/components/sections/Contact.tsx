            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="inline-block px-1 -ml-1 text-sm text-muted-foreground transition-all hover:text-primary hover:underline rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
                  <a
                    ...
                    aria-label="Contact DinoDiv via WhatsApp at +201028661605"
                    className="inline-block px-1 -ml-1 text-muted-foreground transition-all hover:text-primary hover:underline rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  >
                    +201028661605
                  </a>
                  <span>/</span>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Contact DinoDiv via WhatsApp at +201125011939"
                    className="inline-block px-1 text-muted-foreground transition-all hover:text-primary hover:underline rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  >
                    +201125011939
                  </a>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-1 -ml-1 text-sm text-primary transition-all hover:underline rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
                  Let's Talk →
                </a>
              </div>

              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-1">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block px-1 -ml-1 rounded-md transition-all text-sm text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary font-medium"
                  >
                    Let's Talk →
                  </a>
                </div>

            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="px-1 -ml-1 rounded text-sm text-muted-foreground transition-colors hover:text-primary focus:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                >
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center text-sm text-muted-foreground">
                  <a
                    ...
                    className="px-1 -ml-1 rounded transition-colors hover:text-primary focus:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                  >
                    +201028661605
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-1 rounded transition-colors hover:text-primary focus:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                  >
                    +201125011939
                  </a>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-1 -ml-1 rounded text-sm text-primary transition-colors hover:text-primary/80 focus:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                >
                  Let's Talk →
                </a>
              </div>

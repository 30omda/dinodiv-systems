              ...
              <div>
                ...
                <div className="flex flex-wrap items-center">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block px-1 rounded text-sm text-muted-foreground transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary outline-none"
                  >
                    +201125011939
                  </a>
                </div>

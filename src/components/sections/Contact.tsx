            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="rounded text-sm text-muted-foreground transition-colors hover:text-primary hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                >
              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  <a
                    ...
                    className="rounded px-1 -ml-1 transition-colors hover:text-primary hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                  >
                    +201028661605
                  </a>
                  {" / "}
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="rounded px-1 transition-colors hover:text-primary hover:underline focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary"
                  >
                    +201125011939
                  </a>
                </div>

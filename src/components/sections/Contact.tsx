              ...
              <div>
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm text-muted-foreground transition-colors hover:text-primary px-1 rounded focus-visible:ring-1 focus-visible:ring-primary outline-none"
                  >
                    +201125011939
                  </a>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-primary hover:underline px-1 -ml-1 rounded focus-visible:ring-1 focus-visible:ring-primary outline-none"
                >
                  Let's Talk →
                </a>
              </div>

          ...
          >
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  className="h-auto px-4 py-3 bg-card rounded-lg border-border focus:ring-primary"
                />
              </div>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={5}
                required
                className="resize-none px-4 py-3 bg-card rounded-lg border-border focus:ring-primary"

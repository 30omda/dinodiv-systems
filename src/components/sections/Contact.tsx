            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  className="inline-block px-1 -ml-1 rounded-md text-sm text-muted-foreground hover:text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-all"
                >
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-1">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block px-1 rounded-md text-sm text-muted-foreground hover:text-primary hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-all"
                  >
                    +201125011939
                  </a>
                </div>

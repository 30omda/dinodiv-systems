          ...
          >
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="name" name="name" placeholder="Your Name" required className="h-auto py-3" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="email">Email Address</Label>
                <Input id="email" type="email" name="email" placeholder="Email Address" required
                  aria-invalid={!!state.errors?.getErrors("email")?.length} aria-describedby="email-error" className="h-auto py-3" />
            ...
            <div className="space-y-2">
              ...
              <Input id="company" name="company" placeholder="Company Name" className="h-auto py-3" />
            </div>

            <div className="space-y-2">
              <Label htmlFor="message">Tell us about your project...</Label>
              <Textarea id="message" name="message" placeholder="Tell us about your project..." rows={5} required
                aria-invalid={!!state.errors?.getErrors("message")?.length} aria-describedby="message-error" />

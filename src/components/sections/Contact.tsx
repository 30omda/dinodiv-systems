              ...
              <div>
                ...
                <div className="flex flex-wrap items-center text-sm text-muted-foreground">
                  <a
                    ...
                    className="transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary outline-none px-1 -ml-1 rounded"
                  >
                    +201028661605
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="transition-colors hover:text-primary focus-visible:ring-1 focus-visible:ring-primary outline-none px-1 rounded"
                  >
                    +201125011939
                  </a>
                </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-sm text-primary transition-colors hover:text-primary/80 focus-visible:ring-1 focus-visible:ring-primary outline-none px-1 -ml-1 rounded"
                >
                  Let's Talk →
                </a>
              </div>

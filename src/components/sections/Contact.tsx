          ...
          >
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <Input id="name" type="text" name="name" placeholder="Your Name" required className="h-auto bg-card py-3" />
              </div>
              <div>
            ...
            <div>
              ...
              <Input id="company" type="text" name="company" placeholder="Company Name" className="h-auto bg-card py-3" />
            </div>
            {/* Message */}
            <div>

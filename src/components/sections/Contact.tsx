              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-1">
                  <a
                    ...
                    className="inline-block px-1 -ml-1 rounded-md transition-all text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-muted-foreground hover:text-primary hover:underline"
                    aria-label="Chat with us on WhatsApp number +201028661605"
                  >
                    +201028661605
                  </a>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block px-1 rounded-md transition-all text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-muted-foreground hover:text-primary hover:underline"
                    aria-label="Chat with us on WhatsApp number +201125011939"
                  >
                    +201125011939
                  </a>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-1">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-block px-1 -ml-1 rounded-md transition-all text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-primary hover:underline font-medium"
                  >
                    Let's Talk →
                  </a>
                </div>

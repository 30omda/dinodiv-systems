              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-1 text-sm text-muted-foreground">
                  <a
                    ...
                    className="inline-block px-1 -ml-1 rounded-md transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-muted-foreground hover:text-primary hover:underline"
                  >
                    +201028661605
                  </a>
                  <span>/</span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block px-1 -ml-1 rounded-md transition-all text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-primary hover:underline"
                >
                  Let's Talk →
                </a>
              </div>

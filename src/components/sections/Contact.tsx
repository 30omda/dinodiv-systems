          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a href="mailto:contact@dinodiv.info" className="rounded text-sm text-muted-foreground transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary">contact@dinodiv.info</a>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-x-2 text-sm text-muted-foreground">
                  <a href="https://wa.me/201028661605" target="_blank" rel="noopener noreferrer" className="rounded transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary">+201028661605</a>
                  <span>/</span>
                  <a href="https://wa.me/201125011939" target="_blank" rel="noopener noreferrer" className="rounded transition-colors hover:text-primary focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary">+201125011939</a>
                </div>
              </div>
            </div>
            <div className="flex items-start gap-4">

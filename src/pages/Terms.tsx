            ...
            <div>
              ...
              <p>
                ...
                <a
                  ...
                  className="inline-block px-1 -mx-1 rounded-md transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary text-primary hover:underline"
                >

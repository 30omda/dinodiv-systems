            ...
            <div>
              ...
              <p>
                ...
                <a
                  ...
                  className="inline-block px-1 -ml-1 rounded-md text-primary transition-all hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary font-medium"
                >
